...
class DiscordFivemApi {
    constructor(ip) {
        if (!ip) throw Error('Please provide a serverIP and serverPort. Need Help? Check Out: https://discord.gg/MyNBqJf63E');
        this.ip = ip;
        this.note = 'Need Help? Check Out: https://discord.gg/MyNBqJf63E'
    }
